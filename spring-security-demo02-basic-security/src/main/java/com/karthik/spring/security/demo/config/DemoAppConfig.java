...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.karthik.spring.security.demo")
...
public class DemoAppConfig {
	...
	public DataSource securityDataSource() {
		...
		logger.info(">>>>>> Driver class :"+securityDataSource.getDriverClass());
		// logger
	...
	// set helper method to assign int to env property
